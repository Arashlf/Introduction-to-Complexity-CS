...
to paint-slot-machine
  ...
  foreach sort patches [ ?1 -> ask ?1 [set pcolor item n background-image] set n  n + 1 ]
end
...
to save-image
let saved []
foreach sort patches [ ?1 -> set saved lput [pcolor] of ?1 saved ]
...
438
55
Slot Machine: Microstates and Macrostates
18
95.0
1
...
If you use this model, please cite it as: "Slot Machine" model, Complexity Explorer project, http://complexityexplorer.org
